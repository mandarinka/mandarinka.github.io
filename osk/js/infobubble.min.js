...
void 0==a.disableAutoPan&&(a.disableAutoPan=!1);void 0==a.disableAnimation&&(a.disableAnimation=!1);void 0==a.minWidth&&(a.minWidth=this.MIN_WIDTH_);void 0==a.shadowStyle&&(a.shadowStyle=this.SHADOW_STYLE_);void 0==a.arrowSize&&(a.arrowSize=this.ARROW_SIZE_);void 0==a.arrowStyle&&(a.arrowStyle=this.ARROW_STYLE_);this.buildDom_();this.setValues(a)}window.InfoBubble=InfoBubble;InfoBubble.prototype.ARROW_SIZE_=15;InfoBubble.prototype.ARROW_STYLE_=0;InfoBubble.prototype.SHADOW_STYLE_=1;
InfoBubble.prototype.MIN_WIDTH_=50;InfoBubble.prototype.ARROW_POSITION_=50;InfoBubble.prototype.PADDING_=10;InfoBubble.prototype.BORDER_WIDTH_=1;InfoBubble.prototype.BORDER_COLOR_="#ccc";InfoBubble.prototype.BORDER_RADIUS_=10;InfoBubble.prototype.BACKGROUND_COLOR_="#fff";InfoBubble.prototype.extend=function(a,b){return function(a){for(var b in a.prototype)this.prototype[b]=a.prototype[b];return this}.apply(a,[b])};
InfoBubble.prototype.buildDom_=function(){var a=this.bubble_=document.createElement("DIV");a.style.position="absolute";a.style.zIndex=this.baseZIndex_;(this.tabsContainer_=document.createElement("DIV")).style.position="relative";var b=this.close_=document.createElement("IMG");b.style.position="absolute";b.style.width=this.px(12);b.style.height=this.px(12);b.style.border=0;b.style.zIndex=this.baseZIndex_+1;b.style.cursor="pointer";b.src="http://maps.gstatic.com/intl/en_us/mapfiles/iw_close.gif";var c=
this;google.maps.event.addDomListener(b,"click",function(){c.close();google.maps.event.trigger(c,"closeclick")});var d=this.contentContainer_=document.createElement("DIV");d.style.overflowX="auto";d.style.overflowY="auto";d.style.cursor="default";d.style.clear="both";d.style.position="relative";var g=this.content_=document.createElement("DIV");d.appendChild(g);g=this.arrow_=document.createElement("DIV");g.style.position="relative";var e=this.arrowOuter_=document.createElement("DIV"),f=this.arrowInner_=
document.createElement("DIV"),h=this.getArrowSize_();e.style.position=f.style.position="absolute";e.style.left=f.style.left="50%";e.style.height=f.style.height="0";e.style.width=f.style.width="0";e.style.marginLeft=this.px(-h);e.style.borderWidth=this.px(h);e.style.borderBottomWidth=0;h=this.bubbleShadow_=document.createElement("DIV");h.style.position="absolute";a.style.display=h.style.display="none";a.appendChild(this.tabsContainer_);a.appendChild(b);a.appendChild(d);g.appendChild(e);g.appendChild(f);
a.appendChild(g);a=document.createElement("style");a.setAttribute("type","text/css");this.animationName_="_ibani_"+Math.round(1E4*Math.random());a.textContent="";document.getElementsByTagName("head")[0].appendChild(a)};InfoBubble.prototype.setBackgroundClassName=function(a){this.set("backgroundClassName",a)};InfoBubble.prototype.setBackgroundClassName=InfoBubble.prototype.setBackgroundClassName;InfoBubble.prototype.backgroundClassName_changed=function(){this.content_.className=this.get("backgroundClassName")};
InfoBubble.prototype.backgroundClassName_changed=InfoBubble.prototype.backgroundClassName_changed;InfoBubble.prototype.setTabClassName=function(a){this.set("tabClassName",a)};InfoBubble.prototype.setTabClassName=InfoBubble.prototype.setTabClassName;InfoBubble.prototype.tabClassName_changed=function(){this.updateTabStyles_()};InfoBubble.prototype.tabClassName_changed=InfoBubble.prototype.tabClassName_changed;
InfoBubble.prototype.getArrowStyle_=function(){return parseInt(this.get("arrowStyle"),10)||0};InfoBubble.prototype.setArrowStyle=function(a){this.set("arrowStyle",a)};InfoBubble.prototype.setArrowStyle=InfoBubble.prototype.setArrowStyle;InfoBubble.prototype.arrowStyle_changed=function(){this.arrowSize_changed()};InfoBubble.prototype.arrowStyle_changed=InfoBubble.prototype.arrowStyle_changed;InfoBubble.prototype.getArrowSize_=function(){return parseInt(this.get("arrowSize"),10)||0};
InfoBubble.prototype.setArrowSize=function(a){this.set("arrowSize",a)};InfoBubble.prototype.setArrowSize=InfoBubble.prototype.setArrowSize;InfoBubble.prototype.arrowSize_changed=function(){this.borderWidth_changed()};InfoBubble.prototype.arrowSize_changed=InfoBubble.prototype.arrowSize_changed;InfoBubble.prototype.setArrowPosition=function(a){this.set("arrowPosition",a)};InfoBubble.prototype.setArrowPosition=InfoBubble.prototype.setArrowPosition;
...
InfoBubble.prototype.getZIndex=function(){return parseInt(this.get("zIndex"),10)||this.baseZIndex_};InfoBubble.prototype.zIndex_changed=function(){var a=this.getZIndex();this.bubble_.style.zIndex=this.baseZIndex_=a;this.close_.style.zIndex=a+1};InfoBubble.prototype.zIndex_changed=InfoBubble.prototype.zIndex_changed;InfoBubble.prototype.setShadowStyle=function(a){this.set("shadowStyle",a)};InfoBubble.prototype.setShadowStyle=InfoBubble.prototype.setShadowStyle;
...
InfoBubble.prototype.updateArrowStyle_=function(){var a=this.getBorderWidth_(),b=this.getArrowSize_(),c=this.getArrowStyle_(),d=this.px(b),g=this.px(Math.max(0,b-a)),e=this.arrowOuter_,f=this.arrowInner_;this.arrow_.style.marginTop=this.px(-a);e.style.borderTopWidth=d;f.style.borderTopWidth=g;0==c||1==c?(e.style.borderLeftWidth=d,f.style.borderLeftWidth=g):e.style.borderLeftWidth=f.style.borderLeftWidth=0;0==c||2==c?(e.style.borderRightWidth=d,f.style.borderRightWidth=g):e.style.borderRightWidth=
...
InfoBubble.prototype.draw=function(){var a=this.getProjection();if(a){var b=this.get("position");if(b){var c=0;this.activeTab_&&(c=this.activeTab_.offsetHeight);var d=this.getAnchorHeight_(),g=this.getArrowSize_(),e=this.getArrowPosition_(),e=e/100,a=a.fromLatLngToDivPixel(b),b=this.contentContainer_.offsetWidth,f=this.bubble_.offsetHeight;if(b){f=a.y-(f+g);d&&(f-=d);var h=a.x-b*e;this.bubble_.style.top=this.px(f);this.bubble_.style.left=this.px(h);switch(parseInt(this.get("shadowStyle"),10)){case 1:this.bubbleShadow_.style.top=
this.px(f+c-1);this.bubbleShadow_.style.left=this.px(h);this.bubbleShadow_.style.width=this.px(b);this.bubbleShadow_.style.height=this.px(this.contentContainer_.offsetHeight-g);break;case 2:b*=.8,this.bubbleShadow_.style.top=d?this.px(a.y):this.px(a.y+g),this.bubbleShadow_.style.left=this.px(a.x-b*e),this.bubbleShadow_.style.width=this.px(b),this.bubbleShadow_.style.height=this.px(2)}}}else this.close()}};InfoBubble.prototype.draw=InfoBubble.prototype.draw;
...
InfoBubble.prototype.panToView=function(){var a=this.getProjection();if(a&&this.bubble_){var b=this.getAnchorHeight_(),c=this.bubble_.offsetHeight+b,b=this.get("map"),d=b.getDiv().offsetHeight,g=this.getPosition(),e=a.fromLatLngToContainerPixel(b.getCenter()),g=a.fromLatLngToContainerPixel(g),c=e.y-c,d=d-e.y,e=0;0>c&&(e=(-1*c+d)/2);g.y-=e;g=a.fromContainerPixelToLatLng(g);b.getCenter()!=g&&b.panTo(g)}};InfoBubble.prototype.panToView=InfoBubble.prototype.panToView;
...
InfoBubble.prototype.setTabStyle_=function(a){var b=this.get("backgroundColor"),c=this.get("borderColor"),d=this.getBorderRadius_(),g=this.getBorderWidth_(),e=this.getPadding_(),f=this.px(-Math.max(e,d)),d=this.px(d),h=this.baseZIndex_;a.index&&(h-=a.index);var b={cssFloat:"left",position:"relative",cursor:"pointer",backgroundColor:b,border:this.px(g)+" solid "+c,padding:this.px(e/2)+" "+this.px(e),marginRight:f,whiteSpace:"nowrap",borderRadiusTopLeft:d,MozBorderRadiusTopleft:d,webkitBorderTopLeftRadius:d,
borderRadiusTopRight:d,MozBorderRadiusTopright:d,webkitBorderTopRightRadius:d,zIndex:h,display:"inline"},k;for(k in b)a.style[k]=b[k];k=this.get("tabClassName");void 0!=k&&(a.className+=" "+k)};InfoBubble.prototype.addTabActions_=function(a){var b=this;a.listener_=google.maps.event.addDomListener(a,"click",function(){b.setTabActive_(this)})};InfoBubble.prototype.setTabActive=function(a){(a=this.tabs_[a-1])&&this.setTabActive_(a.tab)};InfoBubble.prototype.setTabActive=InfoBubble.prototype.setTabActive;
...
document.body.removeChild(d);delete d;return a};InfoBubble.prototype.redraw_=function(){this.figureOutSize_();this.positionCloseButton_();this.draw()};
InfoBubble.prototype.figureOutSize_=function(){var a=this.get("map");if(a){var b=this.getPadding_();this.getBorderWidth_();this.getBorderRadius_();var c=this.getArrowSize_(),d=a.getDiv(),g=2*c,a=d.offsetWidth-g,d=d.offsetHeight-g-this.getAnchorHeight_(),g=0,e=this.get("minWidth")||0,f=this.get("minHeight")||0,h=this.get("maxWidth")||0,k=this.get("maxHeight")||0,h=Math.min(a,h),k=Math.min(d,k),p=0;if(this.tabs_.length)for(var m=0,l;l=this.tabs_[m];m++){var n=this.getElementSize_(l.tab,h,k);l=this.getElementSize_(l.content,
h,k);e<n.width&&(e=n.width);p+=n.width;f<n.height&&(f=n.height);n.height>g&&(g=n.height);e<l.width&&(e=l.width);f<l.height&&(f=l.height)}else m=this.get("content"),"string"==typeof m&&(m=this.htmlToDocumentFragment_(m)),m&&(l=this.getElementSize_(m,h,k),e<l.width&&(e=l.width),f<l.height&&(f=l.height));h&&(e=Math.min(e,h));k&&(f=Math.min(f,k));e=Math.max(e,p);e==p&&(e+=2*b);e=Math.max(e,2*c);e>a&&(e=a);f>d&&(f=d-g);this.tabsContainer_&&(this.tabHeight_=g,this.tabsContainer_.style.width=this.px(p));
this.contentContainer_.style.width=this.px(e);this.contentContainer_.style.height=this.px(f)}};InfoBubble.prototype.getAnchorHeight_=function(){if(this.get("anchor")){var a=this.get("anchorPoint");if(a)return-1*a.y}return 0};InfoBubble.prototype.anchorPoint_changed=function(){this.draw()};InfoBubble.prototype.anchorPoint_changed=InfoBubble.prototype.anchorPoint_changed;
InfoBubble.prototype.positionCloseButton_=function(){this.getBorderRadius_();var a=this.getBorderWidth_(),b=2;this.tabs_.length&&this.tabHeight_&&(b+=this.tabHeight_);var b=b+a,a=2+a,c=this.contentContainer_;c&&c.clientHeight<c.scrollHeight&&(a+=15);this.close_.style.right=this.px(a);this.close_.style.top=this.px(b)};